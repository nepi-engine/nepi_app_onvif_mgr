...
from nepi_app_onvif_mgr.msg import OnvifDeviceCfg, OnvifDeviceStatus
...
from nepi_app_onvif_mgr.srv import OnvifDeviceDriverListQuery, OnvifDeviceDriverListQueryResponse
